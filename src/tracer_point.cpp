 ...
 * @return Nothing
 */
void ActionTracer::TracePoint::_deselect_me() { digitalWrite( _pin_number, LOW ); }
 ...
 * @return None
 */
void ActionTracer::TracePoint::set_calibrate( bool in_value ) { _calibrate = in_value; }
...
uint16_t ActionTracer::TracePoint::get_pin_number() const { return _pin_number; }
