...
#define I2C_BUFFER_LENGTH		 8192
#define MAX30102_MAX_FIFO_LENGTH 288

// The following methods should be defined by the user
extern unsigned int millis( void );
extern void			delay( unsigned int duration );

class MAX30102 {
  public:
	MAX30102( void );

	bool begin( uint8_t i2caddr = MAX30102_ADDRESS );
